...
<body onload="init(this.productWrite);">
	<div class="page-wrapper">
		...
		<section class="cta">
			...
			<div>
				<h1 style="color: #48BDC5;">분실물</h1>
				<hr/>
				<h4><a href="#">분실물 검색</a></h4>
				<hr/>
				<h4><a href="#">분실물 신고</a></h4>
				<hr/>
			</div>
			</div>
			...
			<div class="container" style="height: 250px; border: 3px solid #48BDC5; ">
				<div class="row">
					<div class="col-md-12">
						...
						<form name="productWrite" id="" action="#" method="post">
						...
						<div class="qnb5_r" style="float:right; width:500px; padding: 20px;">
							...
							<label for="분실자명">분실장소</label>
							<input type="text" id="분실장소" name=""/> <br/>
						...
						<div class="cta-block">
							<div class="find_listBox">
								...
								<c:forEach var="page" begin="1" end="${list.pageTotalCount}">
									<a href="<c:url value='/article/lost/list?atc_type=분실물&page=${page}'/>">${page}</a>
								</c:forEach>
							</div>
							</div>
							<!-- section -->
